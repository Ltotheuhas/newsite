    ...
    data() {
        return {
            dailyMessages: [
                ...
                "rockstar lifestyle #sorrynotsorry",
                "no wave",
                "GOD DID",
                ":3",
                "tiddies out just like new orleans",
                "Klink (Outro)",
                "ear sex",
                "noise buffering.",
                "pixie techno",
                "nsa security camera hack tutorial",
                "how do i use winrar",
                "240p",
                "xD",
                "random word generator",
                "listen in full on mixcloud.com",
                "###basedrain",
                "whole fit aero",
                "browsing 4chan at a pivotal developmental stage",
                "updating my tumblr gore blog whilst browsing the latest Mishka drop",
                "▓̷̛̰̙̯͓̚͜▒̸̛͓͔̜͍̳͇͇͎̯̻͉͊́̅̋̓̔̔͑͋̉̋̄̑̍̋̈́̚̚▓̶̨͙̲̦̙͇̙͊░̸͓̞̼͚̬̼̥̬̬̝̤̺̜̤̱͎̀͒̍͗́̒͜͜͜▓̷͍̟͍̞̜͇͇͚̳͎̘̗̙̈́̂́̈́̑̓̿̇̄̅́͂̌͌̾̿͒͆͘͝͝ͅͅͅ▓̴̨͖̹͕̤̜̜̠̺̝̥̗̮̣͓̆͆̍̽̄̽̎̓̀͐͑͊̕ͅͅ",
